...
@export var tire_back_turn_speed := 1.25
...
func _basic_steering_rotation(delta: float) -> void:
	...
	if turn_input:
		...
		$WHEEL_FR.rotation.y = move_toward($WHEEL_FR.rotation.y, 0, tire_max_turn_degrees * delta / 20)
		$WHEEL_FL.rotation.y = move_toward($WHEEL_FL.rotation.y, 0, tire_max_turn_degrees * delta / 20)
		#$WHEEL_RR.rotation.y = move_toward($WHEEL_RR.rotation.y, 0, tire_back_max_turn_degrees * delta / 20)
		#$WHEEL_RL.rotation.y = move_toward($WHEEL_RL.rotation.y, 0, tire_back_max_turn_degrees * delta / 20)
